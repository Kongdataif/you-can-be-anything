...
screen keyboard_help():
    ...
    hbox:
        label _("Enter")
        text _("Advance dialogue and activate the interface.")

    hbox:
        label _("Space")
        text _("Advance dialogue without selecting choices.")
    ...
    hbox:
        label _("Ctrl")
        text _("Skip dialogue while held down.")

    hbox:
        label _("Tab")
        text _("Toggle dialogue skipping.")
    ...
    hbox:
        label "S"
        text _("Save a screenshot.")

    hbox:
        label "V"
        text _("Toggle {a=https://www.renpy.org/l/voicing}self-voicing{/a}.")
