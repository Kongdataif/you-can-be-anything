...
define config.name = _("You Can Be Anything")
...
# Use English explicitly so the legacy `tl/None` Korean template translation
# does not override base interface labels such as Quit and confirmation text.
...
define build.name = "You Can Be Anything"
...
define config.save_directory = "Choose-1758378693"
